    ...
    <form v-on:submit.prevent="onSubmit">
      ...
      <div class="form-group mb-4">
        ...
        <div class="d-flex dayhours">
          <p class="day">Lundi :</p>
          <input
            v-model="form.hours.mon[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.mon[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          <p class="day">Mardi :</p>
          <input
            v-model="form.hours.tue[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.tue[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          ...
          <input
            v-model="form.hours.wed[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.wed[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          <p class="day">Jeudi :</p>
          <input
            v-model="form.hours.thu[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.thu[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          ...
          <input
            v-model="form.hours.fri[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.fri[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          ...
          <input
            v-model="form.hours.sat[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.sat[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
        ...
        <div class="d-flex dayhours">
          ...
          <input
            v-model="form.hours.sun[0]"
            type="time"
            class="form-control hours"
            id="link"
          />
          <input
            v-model="form.hours.sun[1]"
            type="time"
            class="form-control hours"
            id="link"
          />
...
export default {
  ...
  methods: {
    async onSubmit() {
      await BarService.editBar(this.barId, this.form, this.bearer).then(() => {
        this.$router.push("/bars");
      });
    },
    async fetchBar(id) {
      await BarService.fetchBar(id, this.bearer).then(
        (data) => (this.form = data)
      );
    },
  },
  created() {
    this.fetchBar(this.barId);
  },
};
</script>
